...
module.exports = {
  publishedAddress: "0xeD0F31001f895D4Eb8F2b63A5EF46A27CB27AD7a",
  defaultNetwork,
  ...
  networks: {
    testnet: {
      ...
      accounts: [
        "2d2d32ee24b74458a4bc93d80938488449e5712bde3b2aa13631b68ef0a37d6d",
      ],
    },
    mainnet: {
  ...
  namedAccounts: {
    deployer: {
      default: config.deployer, // here this will by default take the first account as deployer
    },
  },
  etherscan: {
    apiKey: "xxx",
